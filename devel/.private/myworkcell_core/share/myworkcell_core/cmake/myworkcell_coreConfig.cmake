...
if("TRUE" STREQUAL "TRUE")
  set(myworkcell_core_SOURCE_PREFIX /home/toby4548/catkin_ws/src/myworkcell_core)
  set(myworkcell_core_DEVEL_PREFIX /home/toby4548/catkin_ws/devel/.private/myworkcell_core)
  ...
  set(myworkcell_core_INSTALL_PREFIX /home/toby4548/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'myworkcell_core' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'toby4548 <toby4548@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'myworkcell_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/toby4548/catkin_ws/src/myworkcell_core/${idir}'.  Ask the maintainer 'toby4548 <toby4548@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/toby4548/catkin_ws/devel/.private/myworkcell_core/lib;/home/toby4548/catkin_ws/devel/lib;/opt/ros/indigo/lib)
