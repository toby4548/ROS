...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'myworkcell_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/toby4548/catkin_ws/install/${idir}'.  Ask the maintainer 'toby4548 <toby4548@todo.todo>' to fix it.")
    endif()
